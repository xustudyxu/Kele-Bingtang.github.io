...
- Windows 上传安装包到 Linux，我就是这一步
    ...
    ![image-20211105154727114](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211105154925.png)
...
![image-20211105155933746](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211105160008.png)
...
- 进行**初始化**操作，并记住初始化密码，登录需要
    ...
    ![image-20211105162919004](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211105162958.png)
...
1. 启动 MySQL 服务时，报错：
    ...
    2. 登录到 mysql 用户，启动 MySQL 服务，需要在 `my.cnf` 文件的底部，添加 `user=mysql`
        ...
        ![image-20211105172231086](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/MySQL/20211105172232.png)
