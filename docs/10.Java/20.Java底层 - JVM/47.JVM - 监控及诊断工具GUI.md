...
![image-20210505141631635](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131223023.png)

![image-20210505141726143](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131223025.png)

![image-20210505141924211](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131223029.png)

![image-20210505141950000](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131223032.png)

![image-20210505142050157](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131223035.png)
...
![image-20220131224447624](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131224448.png)

按照完插件之后，重启 Idea ，然后配置 Visual VM 的启动路径：

![image-20220131224552415](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201143925.png)
...
![image-20220131225514738](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131225516.png)

![image-20220131225731574](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131225732.png)

![image-20220131225659672](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131225701.png)

![image-20220131232928306](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131232929.png)
...
![image-20220131232636697](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131232638.png)

打开后的界面：

![image-20220131232737535](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131232738.png)

概述，查看堆大小，类的数量，类加载器等信息。

![image-20220131233225517](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131233226.png)

![image-20220131233533551](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131233534.png)

![image-20220131233645314](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131233646.png)

> Histogram 直方图

![image-20220131233915003](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131233930.png)

thread overview：查看系统中的 Java 线程，查看局部变量表的信息。

![image-20220131234401041](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131234402.png)

> 查看对象互相引用的关系

在 MAT 工具的 thread overview 中，右键目标类找到 `with outgoing references` 或 `with incoming references`。即可查看谁引用了该类，该类引用了谁。

![image-20220131234920860](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220131234921.png)
...
![image-20220201003432711](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201003434.png)



练习：

![image-20220201003650210](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201135833.png)
...
![image-20220201003643235](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201135835.png)
...
![image-20220201005307683](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201005308.png)
...
![image-20220201010504721](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201010505.png)
...
![image-20220201010932876](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201010933.png)
...
![image-20220201012013800](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201012017.png)

图 2：

![image-20220201012135383](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201012136.png)

图 3：sessions 对象，它占用了约 17MB 空间。

![image-20220201011857288](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220208185032.png)

图 4：可以看到 sessions 对象为 ConcurrentHashMap，其内部分为 16 个 Segment。从深堆大小看，每个 Segment 都比较平均，大约为 1MB，合计 17MB。

![image-20220201012354238](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201012355.png)

图 5：

![image-20220201012443880](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201012444.png)

图 6：当前堆中含有 9941 个 session，并且每一个 session 的深堆为 1592 字节，合计约 15NB，达到当前堆大小的 50%。

![image-20220201012624399](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201012627.png)

图 7：

![image-20220201012758369](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201012759.png)

图 8：

![image-20220201012222622](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201012223.png)
...
![image-20210505152542224](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201150827.png)
...
![image-20210505152704141](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201230257.png)
...
![image-20210505160114618](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201160547.png)

当进行大量的 pop 操作时，由于引用未进行置空，GC 是不会释放的，如下图所示

![image-20220201160456212](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201160457.png)
...
![image-20210505160423289](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201160608.png)
...
![image-20220201162722104](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201162722.png)
...
![image-20210505164521410](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201163747.png)

![image-20220201163821835](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201163826.png)

![image-20210505164815324](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201163851.png)

![image-20210505164945192](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201163853.png)

![image-20210505165010529](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201163854.png)

![image-20210505165128212](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201163856.png)

![image-20210505165249919](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201163858.png)
...
![image-20220201164328735](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201164329.png)
...
![image-20210505164554298](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201164332.png)

![image-20210505165519790](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201164333.png)

### 堆遍历 heap walker

![image-20210505165710620](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201164334.png)

![image-20210505165823201](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201164336.png)
...
![image-20210505170055722](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201165054.png)

![image-20210505170141278](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201165055.png)
...
![image-20220201165337435](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201165339.png)

![image-20210505170739972](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201165056.png)
...
![image-20220201170051789](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201170052.png)

![image-20220201170106558](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201170107.png)
...
![image-20220201170352569](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201170353.png)

![image-20220201170506350](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201170507.png)
...
![image-20220201172653188](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201172654.png)
...
![image-20210505184358041](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201202058.png)
...
![image-20210505185941373](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201202119.png)

![image-20210505185954567](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201202121.png)

![image-20210505190009274](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201202122.png)

![image-20210505190023099](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201202123.png)

![image-20210505190037354](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201202124.png)

![image-20210505190052561](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201202125.png)

![image-20210505190106004](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201202127.png)
...
![image-20210505190823214](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201202321.png)
...
![image-20210505192042974](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220201230309.png)
