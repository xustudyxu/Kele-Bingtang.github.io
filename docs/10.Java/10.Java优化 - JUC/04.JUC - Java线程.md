...
本知识体系的代码不适用 `System.out.println()` 输出到控制台，而是使用 `log.info` 进行输出，下面是 log 的依赖：
...
![image-20220507171957876](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220507172006.png)
...
![image-20220507181428385](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220507181429.png)
...
![image-20220508012643450](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220508012652.png)
