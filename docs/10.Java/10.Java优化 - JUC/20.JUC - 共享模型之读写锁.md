...
![img](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518181408.png)
...
![image-20220518180541056](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518180543.png)
...
![image-20220518180852266](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518180853.png)

## ReentrantLock 原理

![image-20220518182003741](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518182005.png)
...
![image-20220518182229214](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518182230.png)

第一个竞争出现时

![image-20220518182302615](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518182303.png)
...
![image-20220518183826540](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518185458.png)
...
![image-20220518182738727](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518182739.png)
...
![image-20220518182915671](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518182916.png)

再次有多个线程经历上述过程竞争失败，变成这个样子（灰色表示）：

![image-20220518185454678](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518185455.png)
...
![image-20220518185515462](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518185516.png)
...
![image-20220518190920836](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518190921.png)
...
![image-20220518191105784](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220518191106.png)
...
非公平锁的 tryAcquire 方法，不回去检测 AQS 队列。
...
![image-20220519005528931](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220519005529.png)
...
![image-20220519005715433](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220519005716.png)
...
![image-20220519005835010](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220519005835.png)

加入 ConditionObject 队列的 Thread-0 线程还是运行状态的，所以调用 park 方法阻塞 Thread-0。

![image-20220519005845611](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220519005846.png)
...
![image-20220519005926986](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220519005927.png)
...
![image-20220519010109426](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220519010112.png)

执行 transferForSignal 方法，将该 Node 加入 AQS 队列尾部，将 Thread-0 的 waitStatus 改为 0，Thread-3 的 waitStatus 改为 -1。

![image-20220519010204060](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220519010205.png)
...
![image-20220521004846166](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521004848.png)
...
![image-20220521004953900](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521004954.png)

有一种情况：

假设 A 线程查询数据时缓存没有，所以去数据库获取数据 1，然后 B 线程将新数据 2 存入数据库，并清空缓存，接着 A 线程才将查询到的数据 1 存入缓存，所以 A 线程后面的查询都是从缓存获取旧数据 1。

![image-20220521012033866](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521012035.png)
...
t1 成功上锁，流程与 ReentrantLock 加锁相比没有特殊之处，不同是写锁状态占了 state 的低 16 位，而读锁 使用的是 state 的高 16 位。
...
![image-20220521012757973](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521012758.png)
...
- 15 - 32 行：如果写锁没有被阻塞，且 状态 c 能加 1，代表能获取锁，接着多个 if-else 判断可重入，最后返回 1，代表成功

![image-20220521014613863](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521014614.png)
...
![image-20220521014900294](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521014901.png)
...
![image-20220521015923500](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521015924.png)
...
![image-20220521015603795](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521015604.png)
...
![image-20220521020519281](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521020520.png)

接下来执行唤醒流程 `sync.unparkSuccessor`，即让老二恢复运行，这时 t2 在 doAcquireShared 内 `parkAndCheckInterrupt()` 处恢复运行。

这回再来一次 `for(;;)` 执行 tryAcquireShared 成功则让读锁计数加一。

![image-20220521020909350](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521020910.png)

这时 t2 已经恢复运行，接下来 t2 调用 setHeadAndPropagate(node, 1)，它原本所在节点被置为头节点。

![image-20220521020923190](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521020924.png)

事情还没完，在 setHeadAndPropagate 方法内还会检查下一个节点是否是 shared，如果是则调用 `doReleaseShared()` 将 head 的状态从 -1 改为 0 并唤醒老二，这时 t3 在 doAcquireShared 内 `parkAndCheckInterrupt()` 处恢复运行。

![image-20220521021147654](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521021148.png)
...
![image-20220521021444656](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521021445.png)
...
![image-20220521021549792](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521021550.png)
...
![image-20220521021809433](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521021810.png)

之后 t4 在 acquireQueued 中 parkAndCheckInterrupt 处恢复运行，再次 `for(;;)` 这次自己是老二，并且没有其他竞争，`tryAcquire(1)` 成功，修改头结点，流程结束。

![image-20220521021927262](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521021928.png)
