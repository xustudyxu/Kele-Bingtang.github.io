...
![image-20220509170854982](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509170930.png)

数组对象

![image-20220509170904523](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509170935.png)
...
![image-20220509171038115](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509171039.png)
...
![image-20220509171248707](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509171251.png)
...
每个 Java 对象都可以关联一个 Monitor 对象，如果使用 synchronized 给对象上锁(重量级）之后该对象头的 Mark Word 中就被设置指向 Monitor 对象的指针。

Monitor 结构如下：

![image-20220509171454348](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509171455.png)
...
![image-20220509180137968](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509180138.png)

让锁记录中 Object reference 指向锁对象，并尝试用 cas 替换 Object 的 Mark Word，将 Mark Word 的值存入锁记录。

![image-20220509180215783](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509180216.png)

如果 cas 替换成功，对象头中存储了锁记录地址和状态 00，表示由该线程给对象加锁，这时图示如下：

![image-20220509180234684](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509180235.png)
...
![image-20220509180312315](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509180313.png)
...
![image-20220509181325425](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509181326.png)
...
![image-20220509181418627](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509181421.png)
...
![image-20220509182850742](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509182851.png)



![image-20220509182904165](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509182905.png)
...
![image-20220509215911235](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509215912.png)

于是老王单开了一间休息室（调用 wait 方法），让小南到休息室（WaitSet）等着去了，但这时锁释放开，其它人可以由老王随机安排进屋。

直到小 M 将烟送来，大叫一声 [你的烟到了] （调用 notify 方法）。

![image-20220509215922304](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509215923.png)

小南于是可以离开休息室，重新进入竞争锁的队列。

![image-20220509220320527](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220509220321.png)
...
![image-20220511153837217](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220511153844.png)
...
![image-20220511173538431](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220511173824.png)
...
![image-20220511170449680](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220511170450.png)
