...
![image-20220521160912543](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521160913.png)

假设其中 Thread-1，Thread-2，Thread-4 cas 竞争成功，而 Thread-0 和 Thread-3 竞争失败，进入 AQS 队列 park 阻塞

![image-20220521161253073](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521161254.png)

这时 Thread-4 释放了 permits，状态如下

![image-20220521161421511](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521161422.png)

接下来 Thread-0 竞争成功，permits 再次设置为 0，设置自己为 head 节点，断开原来的 head 节点，unpark 接下来的 Thread-3 节点，但由于 permits 是 0，因此 Thread-3 在尝试不成功后再次进入 park 状态

![image-20220521161803754](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521161831.png)
...
![image-20220521232418588](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220521232419.png)
...
![image-20210517173258323](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524165725.png)
...
![image-20210517173544418](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524165756.png)
...
![image-20220524145256851](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524145305.png)
...
![image-20220524145317529](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524145318.png)

结果再与 this.segmentMask 做位于运算，最终得到 1010 即下标为 10 的 segment。

![image-20220524145329226](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524145330.png)
...
![image-20220524152057209](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524152058.png)

当一个节点入队 `last = last.next = node;`

![image-20220524152119205](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524152120.png)

再来一个节点入队 `last = last.next = node;`

![image-20220524152211505](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524152212.png)
...
![image-20220524152306012](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524152306.png)

`first = h.next`：

![image-20220524152355584](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524152357.png)

`h.next = h`：

![image-20220524152442231](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524152443.png)

`head = first`：

![image-20220524152450699](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524152451.png)
...
![image-20220524154918172](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524154919.png)
...
![image-20220524155435609](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/juc/20220524155436.png)
