...
- 初始值为 null
    ...
    ![image-20220210222230638](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210222231.png)

- 方法引用

    ![image-20220210222158926](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210222201.png)

- Lambda 表达式

    ![image-20220210222208902](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210222209.png)

- 为数组静态数组化

    ![image-20220210222217372](https://fastly.jsdelivr.net/gh/Kele-Bingtang/static/img/Java/20220210222218.png)
